...
namespace Regula.FaceSDK.NetCoreExample
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            var face1 = File.ReadAllBytes("C:\\Users\\labusers\\Desktop\\test2.jpg");
            var face2 = File.ReadAllBytes("C:\\Users\\labusers\\Desktop\\test2.jpg");
           ...
           // var matchImage2 = new MatchImage(data: face1, type: ImageSource.DOCUMENT_RFID);
            ...
            var matchingRequest = new MatchRequest(tag: "1",
                thumbnails: false, images: new List<MatchImage> { matchImage1, matchImage3 }
            );
